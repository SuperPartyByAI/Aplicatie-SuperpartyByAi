...
class DoveziPreviewScreen extends StatefulWidget {
  final String eventId;

  const DoveziPreviewScreen({super.key, required this.eventId});

  @override
  State<DoveziPreviewScreen> createState() => _DoveziPreviewScreenState();
}

class _DoveziPreviewScreenState extends State<DoveziPreviewScreen> {
  final Map<EvidenceCategory, List<String>> _mockThumbs = {};
  final Map<EvidenceCategory, EvidenceStatus> _categoryStatus = {};
  final Map<EvidenceCategory, bool> _categoryLocked = {};
