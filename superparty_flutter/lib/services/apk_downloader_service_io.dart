...
/// Service pentru download APK direct din Firebase Storage (IO implementation)
class ApkDownloaderService {
  ...
  static Future<String?> downloadApk(
    ...
    try {
      ...
      // 1. Obține directorul app-specific
      ...
      debugPrint(
          '[ApkDownloader] Content length: ${contentLength / 1024 / 1024} MB');

      // 5. Stream direct la fișier
        ...
        await for (final chunk in request.stream) {
          ...
          if (contentLength > 0) {
            ...
            if (downloadedBytes % (1024 * 1024) == 0) {
              debugPrint(
                  '[ApkDownloader] Downloaded: ${downloadedBytes / 1024 / 1024} MB');
            }
          }
        }
      } finally {
      ...
      debugPrint(
          '[ApkDownloader] Final size: ${downloadedBytes / 1024 / 1024} MB');
