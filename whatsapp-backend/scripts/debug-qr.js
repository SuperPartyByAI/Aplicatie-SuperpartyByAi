...
async function startDebug() {
  try {
    ...
    const heartbeat = setInterval(() => {
      console.log(`💓 HEARTBEAT: ${new Date().toISOString()} | QR: ${qrEmitted} | Pairing: ${pairingEmitted} | Connected: ${connected}`);
    }, 5000);
    ...
    sock.ev.on('connection.update', async (update) => {
      ...
      console.log(`   lastDisconnect: ${lastDisconnect ? JSON.stringify({
