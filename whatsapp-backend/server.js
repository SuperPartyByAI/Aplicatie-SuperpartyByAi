...
const AI_CONTEXT_MESSAGE_LIMIT = 5; // Reduced to 5 to save tokens and avoid Rate Limits (previously 15-50)
...
async function generateAutoReplyText(groqKey, messages, maxTokens = 500) {
  ...
  console.log(
    `[AutoReply][AI_DEBUG] Sending request: model=llama-3.1-8b-instant roles=${roles} msgs=${messages.length}`
  );
...
6. IMPORTANT: Scrie mereu datele sub forma: "Data: [valoare]", "Persoane: [valoare]", "Locație: [valoare]".
